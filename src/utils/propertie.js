...
const challenges = {
  ...
  animal: [
    ...
    {
      categorie_id: 2,
      question: "Aku hewan yang dikenal dengan leher panjangku, siapakah aku?",
  ...
  history: [
    ...
    },
    {
      ...
      choices: ["Bung Tomo", "Soekarno", "Mohammad Hatta", "Jenderal Sudirman"],
      answer: "Soekarno",
      level: 5,
      point: 1,
    },
  ...
  science: [
    ...
    {
      categorie_id: 5,
      question: "Benda yang mengalami percepatan negatif dikatakan mengalami?",
      choices: [
  ...
  song: [
    {
      categorie_id: 6,
      question: "Siapakah penyanyi legendaris yang dikenal sebagai 'Raja Pop'?",
      choices: [
        "Elvis Presley",
        "Michael Jackson",
        "Frank Sinatra",
    ...
    {
      categorie_id: 6,
      question: "Siapakah penyanyi legendaris yang dikenal sebagai 'The Boss'?",
  ...
  film: [
    ...
    },
    {
      ...
      choices: ["Keanu Reeves", "Brad Pitt", "Tom Cruise", "Leonardo DiCaprio"],
      answer: "Keanu Reeves",
      level: 13,
      point: 15,
    },
